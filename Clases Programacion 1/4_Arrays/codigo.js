...
/* 
let edades= [1, 4, 6, 7,8];
let datosramdom= [1, 4, "Emilio", 7 ,8.0,valor ];

document.write(frutas + "</br>");

frutas.push("Manzana Verde");
...
/* 
 ...
 arr.push(agregarFruta); // Agrega elemento a la array
 document.write(arr  + "</br>"); // br es un salto de linea
